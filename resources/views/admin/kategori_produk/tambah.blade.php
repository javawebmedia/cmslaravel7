...
<form action="{{ url('admin/kategori_produk/tambah') }}" enctype="multipart/form-data" method="post" accept-charset="utf-8">
{{ csrf_field() }}
...
<div class="form-group row">
	...
	<div class="col-md-9">
		...
		@if ($errors->has('nama_kategori_produk'))
	      	<span class="text-danger">{{ $errors->first('nama_kategori_produk') }}</span>
	    @endif  
	</div>
</div>
